...
class Ulv():
    # fjernete et parameter da jeg ikke synes det var nødvendig å ta inn et bilde, når ulven har samme bilde hver gang
    def __init__(self, posisjon_venstre, posisjon_topp, spillbrett):
    ...
    def tenk(self):
        ...
        if len(sti) == 1:
            ...
            if til_x > self._posisjon_venstre:
                ...
                self._retning = Retning.VENSTRE
            elif til_y > self._posisjon_topp:
                self._retning = Retning.NED
            elif til_y < self._posisjon_topp:
                self._retning = Retning.OPP
